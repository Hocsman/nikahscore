                        ...
                        {question.type === 'scale' ? (
                          ...
                          <div className="grid grid-cols-5 gap-3">
                            {[1, 2, 3, 4, 5].map((value) => (
                              <Button
                                ...
                                aria-label={`Répondre ${value} sur 5 à la question: ${question.label}`}
                              >
                                {value}
                              </Button>
                            ))}
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <Button
                              ...
                              size="lg"
                              className="h-12 text-lg font-semibold"
                              aria-label={`Répondre Oui à la question: ${question.label}`}
                            >
                            ...
                            <Button
                              ...
                              size="lg"
                              className="h-12 text-lg font-semibold"
                              aria-label={`Répondre Non à la question: ${question.label}`}
                            >
