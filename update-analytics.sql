-- Script de mise à jour des analytics NikahScore (évite les conflits)
...
-- Suppression des anciennes politiques analytics
...
-- Recréation des politiques analytics
...
-- Suppression des anciennes politiques abonnements
...
-- Recréation des politiques abonnements
...
-- 8. Fonction pour calculer les métriques business (CREATE OR REPLACE évite les conflits)
...
SELECT 'Analytics tables updated successfully! 🚀' as status;
