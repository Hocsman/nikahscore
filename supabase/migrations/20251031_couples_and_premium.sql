...
-- ==========================================
CREATE INDEX IF NOT EXISTS idx_couples_creator ON couples(creator_id);
CREATE INDEX IF NOT EXISTS idx_couples_partner ON couples(partner_id);
...
CREATE INDEX IF NOT EXISTS idx_compatibility_couple ON compatibility_results(couple_id);
